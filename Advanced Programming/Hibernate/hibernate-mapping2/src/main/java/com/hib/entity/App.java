...
public class App {
	...
	public static void main(String[] args) {
		...
		Employee e2 = new Employee(2,"Arun","A",tech2);
		Employee e3 = new Employee(3,"Aadhi","C",tech3);
		Employee e4 = new Employee(4,"Anitha","A",tech4);
		Employee e5 = new Employee(5,"Anjali","B",tech5);
